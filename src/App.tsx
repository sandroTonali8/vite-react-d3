...
import { x, y, marginLeft, marginTop, maxY, dataX, dataY, unitY, minY, height } from './components/constants';

export default function App() {
  return (
    <svg>
      <Svg x={x} marginTop={marginTop} maxY={maxY} y={y} dataX={dataX} dataY={dataY}/>
      <Xaxis x={x} marginTop={marginTop} maxY={maxY} minY={minY} height={height}/>
